#
# Be sure to run `pod lib lint degpeg-b2c-sdk-ios.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'degpeg-b2c-sdk-ios'
  s.version          = '0.1.0'
  s.summary          = 'A short description of degpeg-b2c-sdk-ios.'
